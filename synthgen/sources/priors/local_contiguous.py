...
# Patch extent range matching the focal-source regime used by ESINet / ConvDip.
_EXTENT_CM2_RANGE: tuple[float, float] = (1.0, 10.0)
...
class LocalContiguousPrior(ActivationPrior):
    ...
    def sample(
        ...
        seeds = rng.integers(0, N, size=n).tolist()
